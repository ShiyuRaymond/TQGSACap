...
class MSRVTTDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # 再次检查数量不够就补齐
        # while len(frames) < num_sampled_frames:
        ...
        #                                    max_length=self.max_caption_length, return_tensors='pt')
        ...
        # return video_path, frames_tensor, input_ids, attention_mask, video_embedding
