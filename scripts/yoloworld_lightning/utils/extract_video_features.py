...
def main():
    ...
    video_dir='/workspace/YOLO-World/scripts/yoloworld_lightning/data/msrvtt/videos/TrainValVideo',
    save_dir='/workspace/YOLO-World/scripts/yoloworld_lightning/data/msrvtt/features',
