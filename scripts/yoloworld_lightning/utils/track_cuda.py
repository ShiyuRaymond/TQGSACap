...
if __name__ == "__main__":
    log_file = "/workspace/YOLO-World/scripts/yoloworld_lightning/logs/train_2docoder.log"          # 替换成你的日志文件路径
    output_file = "/workspace/YOLO-World/scripts/yoloworld_lightning/logs/train_2docoder_parell.txt"        # 如果你想把结果保存到新文件
